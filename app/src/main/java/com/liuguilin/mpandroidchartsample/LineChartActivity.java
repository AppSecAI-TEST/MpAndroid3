...
public class LineChartActivity extends BaseActivity implements OnChartGestureListener, OnChartValueSelectedListener, View.OnClickListener {
    ...
    private void initView() {
        ...
        mLineChar.setBackgroundColor( Color.rgb(114, 188, 223));// 设置背景

        mLineChar.getAxisRight().setEnabled(true); // 隐藏右边 的坐标轴
        mLineChar.getXAxis().setPosition(XAxis.XAxisPosition.BOTTOM); // 让x轴在下面
        //x轴
        ...
        ll1.setLineWidth(4f);
      //  ll1.enableDashedLine(10f, 10f, 0f);  设置线条为点线
        ...
        values.add(new Entry(20, 120));
        values.add(new Entry(30, 30));
        values.add(new Entry(40, 10));
        values.add(new Entry(50, 110));
        values.add(new Entry(60, 30));
        values.add(new Entry(70, 80));
        values.add(new Entry(80, 30));
        values.add(new Entry(90, 90));
        values.add(new Entry(100, 110));
    ...
    private void setData(ArrayList<Entry> values) {
        if (mLineChar.getData() != null && mLineChar.getData().getDataSetCount() > 0) {
            ...
            LineDataSet set1 = new LineDataSet(values, "年度总结报告" /*显示在比例图上*/);
            //用y轴的集合来设置参数
            set1.setLineWidth(1.75f); // 线宽
            set1.setValueTextSize(13f);
            set1.setCircleSize(5f);// 显示的圆形大小
